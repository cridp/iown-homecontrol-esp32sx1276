 ...
 */
/// @see https://github.com/markqvist/RNode_Firmware/blob/master/sx126x.cpp

#include <board-config.h>

#if defined (RADIO_SX126X) //MODEM == SX1262
...
bool sx126x::preInit() {
  ...
  digitalWrite(_ss, HIGH);
    ...
    SPI.begin(RADIO_SCLK_PIN /*pin_sclk*/, RADIO_MISO_PIN /*pin_miso*/, RADIO_MOSI_PIN /*pin_mosi*/, RADIO_CS_PIN /*pin_cs*/);
  #else
    SPI.begin();
  #endif
